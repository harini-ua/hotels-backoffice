                        ...
                        <div class="auth-box-right">
                            <div class="card">
                                <div class="card-body">
                                    <form action="#">
                                        <div class="form-head">
                                            <a href="{{url('/demo')}}" class="logo"><img src="{{ asset('assets/images/logo.svg') }}" class="img-fluid" alt="logo"></a>
                                        </div>
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                              <div class="forgot-psw">
                                                <a id="forgot-psw" href="{{url('/demo/user-forgotpsw')}}" class="font-14">Forgot Password?</a>
                                              </div>
                                            </div>
                                        </div>
                                    ...
                                    <p class="mb-0 mt-3">Don't have a account? <a href="{{url('/demo/user-register')}}">Sign up</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Auth Box -->
