                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link mb-2 active" href="{{ route('hotels.edit', $hotel) }}">{{ __('General') }}</a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    @can(\App\Enums\Permission::EDIT_HOTEL)
                                        @include('admin.pages.hotels.general._form')
                                    @else
                                        @include('admin.pages.hotels.general._view')
                                    @endcan
                                </div>
                            </div>
                        </div>
