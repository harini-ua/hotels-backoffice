...
@section('title',  __('Booking Customer'))
...
@section('style')
    ...
    <link href="{{ asset('css/pages/booking-customer.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
    ...
    <script src="{{asset('js/pages/booking-customer.js')}}"></script>
@endsection
