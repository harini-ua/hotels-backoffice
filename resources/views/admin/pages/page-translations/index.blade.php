...
@section('rightbar-content')
    <div class="contentbar page-translations-edit-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <x-filter
                    ...
                    :collapse="false"
                >
                    @include('admin.pages.page-translations.partials._filter')
                </x-filter>
            </div>
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col s12" data-pjax>
                                @include('admin.pages.page-translations.partials._form')
                            </div>
                        </div>
                    </div>
                </div>
